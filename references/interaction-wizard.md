...
The planner is the user-facing intelligence for launch preparation. After launch approval, the harness runs autonomously in the background until it completes or reaches `needs_human`.
